...
less.</span>';
    ...
    echo '<p class="login_prompt">Choose a username: <input maxlength="30" type="text" id="create_username"></p>';
    echo '<p class="login_prompt">Choose a password: <input maxlength="15" type="password" id="create_password"></p>';
